...
struct RoutineView: View {
    ...
    var body: some View {
        NavigationView {
            ZStack {
                // Premium soft background with abstract shapes
                        ...
                        HStack(alignment: .top, spacing: 18) {
                            ...
                            VStack(spacing: 16) {
                                StatBubbleView(
                                    ...
                                    value: "8 cups",
                                    icon: "drop.fill",
                                    gradient: Gradient(colors: [Color.cyan.opacity(0.18), Color.blue.opacity(0.13)])
                                )
                                StatBubbleView(
                                    title: "Workout",
                                    value: "30 min",
                                    icon: "figure.walk",
                                    gradient: Gradient(colors: [Color.green.opacity(0.18), Color.blue.opacity(0.13)])
                                )
                                StatBubbleView(
                                    title: "Weather",
                                    value: "Sunny",
                                    icon: "sun.max.fill",
                                    gradient: Gradient(colors: [Color.orange.opacity(0.18), Color.yellow.opacity(0.13)])
                                )
                            }
...
struct CombinedRoutineView: View {
    var body: some View {
        ...
        .padding()
        .background(LinearGradient(gradient: Gradient(colors: [Color.blue.opacity(0.10), Color.purple.opacity(0.10)]), startPoint: .topLeading, endPoint: .bottomTrailing))
        .cornerRadius(18)
